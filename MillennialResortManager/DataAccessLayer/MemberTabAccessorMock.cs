...
namespace DataAccessLayer
{
    ...
    /// Created 2019-04-30
    /// 
    /// The mock implementation of our IMemberTabAccessor,
    ...
    public class MemberTabAccessorMock : IMemberTabAccessor
    {
        ...
        /// Our fake DataStore.
        /// </summary>
        private List<MemberTab> _memberTabs = new List<MemberTab>();
        ...
        public int DeleteMemberTab(int memberTabID)
        {
            ...
            if (memberTab == null)
            {
                // If we can't find it, we can't perform our Delete. Return 0.
                rowsAffected = 0;
            }
            else
            {
